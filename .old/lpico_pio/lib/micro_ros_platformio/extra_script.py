...
is_build_target = not set(COMMAND_LINE_TARGETS).intersection(set(["clean", "cleanall", "clean_microros", "clean_libmicroros", "_idedata", "idedata"]))
...
def build_microros(*args, **kwargs):
    ...
    if (board == "portenta_h7_m7" or board == "nanorp2040connect" or board == "pico"):
        ...
        global_env["_LIBFLAGS"] = "-Wl,--start-group " + global_env["_LIBFLAGS"] + " -l{}".format(builder.library_name)
    else:
